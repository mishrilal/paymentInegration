        ...
        <div class="col-xs-12 col-sm-2 offset-md-3 col-md-6">
            <form action="payment.php" method="post" class="tabletext">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="email" class="form-control" id="email" name="email" placeholder="johndoe@email.xyz"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="tel" class="form-control" id="mobile" name="mobile" placeholder="9876543210"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="offset-md-5 col-md-7">
                        <button class="btn btn-dark btn-outline-success" type="submit" name="submit"
